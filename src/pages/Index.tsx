...
import stewedChickenPhoto1 from "@/assets/stewed-chicken-photo-1.jpg";
import stewedChickenPhoto2 from "@/assets/stewed-chicken-photo-2.jpg";
import longBeansPorkPhoto1 from "@/assets/long-beans-pork-photo-1.jpg";
import longBeansPorkPhoto2 from "@/assets/long-beans-pork-photo-2.jpg";
...
const soyBeanPorkCapsicumRecipe: Recipe = {
  ...
  steps: [
    ...
    "Pour the bean paste (mixed) into the wok. Let it 焖 for 5 min. Then pour the plate of capsicum all into the wok and let it 焖 for 5 min again.",
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        {recipes.length === 0 ? (
          ...
          <>
            ...
            {/* Main Dishes */}
            <div className="mb-16">
              <h3 className="font-baskerville text-3xl text-primary mb-8 border-b-2 border-primary/20 pb-3">
                Main Dishes
              </h3>
